      ...
      <div className="max-w-md mx-auto py-12">
        ...
        >
          ...
          <button
            onClick={onGoogle}
            disabled={loading}
            className="w-full py-3 px-4 rounded-xl bg-white text-slate-900 font-medium hover:bg-slate-100 transition flex items-center justify-center gap-3 disabled:opacity-50"
          >
