...
import { ListTodo, LineChart, GraduationCap, BookMarked, NotebookPen, Layers, LayoutDashboard } from 'lucide-react'
...
const TABS = [
  ...
  { key: 'pano', label: 'Pano', to: '/pano', Icon: LayoutDashboard },
]
